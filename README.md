{
  "language": "English",
  "startmenu.new_game": "NEW OFFLINE GAME",
  "startmenu.multiplayer": "ONLINE GAMES",
  "startmenu.resume_game": "CONTIUE OFFLINE GAME",
  "startmenu.settings": "Settings",
  "startmenu.high_score": "Measley Scores",
  "startmenu.throne_room": "Room of Failures",
  "startmenu.about": "Info",
  ...
  "gamemodepicker.title": "YOU SUCK BUT HAVE FUN.",

  "tribepicker.title": "PICK YOUR DOOM",
  "tribepicker.categories.humantribes": "Normies",
  "tribepicker.categories.specialtribes": "Weirdos",
  "tribepicker.categories.specialtribes.description": "A collection of tribes that are wonky as hell...",
  "tribepicker.categories.random": "Let your unfortunate fate decide!",
  "tribepicker.categories.random.button": "RANDOM TRIBE",
  "tribepicker.categories.random.selected.title": "Oh shit you fucked up!",
  ...
  "gamesettings.difficulty.easy": "Retarded Bots",
  "gamesettings.difficulty.normal": "Illogical Bots",
  "gamesettings.difficulty.hard": "Kinda Smart Bots",
  "gamesettings.difficulty.crazy": "WAIT HOLD UP",
  "gamesettings.startgame": "EAT ASS",
  "gamesettings.creatingworld": "MAKING THE BREAD",
  ...
  "gamesettings.network.passplay": "A Mode That No One Uses",
  ...
  "gamemode.perfection.description.button": "Gain bragging rights on the global hiscore in the classic 30 turns game.",
  "gamemode.perfection.description": "Get the highest possible score before the time runs out.",
  "gamemode.perfection.win": "We have reached the end of time. BUT NO ONE GIVES A SHIT ABOUT YOUR TRIBE!",
  "gamemode.perfection.loss": "Did you really just lose.. ?",
  "gamemode.domination.caps": "DOMINATION",
  "gamemode.domination": "Domination",
  "gamemode.domination.description.button": "Beat the shit out of everyone else.",
  ...
  "gamemode.domination.loss": "Your last city was lost, and now your family is disappointed.",
  ...
  "world.intro.text": "You have been chosen to rule the {0} tribe. Explore the world and expand your empire, but don't make a single wrong move.",
  "world.intro.objective": "Objective: {0}",
  "world.turn.end": "Oh No",
  "world.turn.end.question": "I Guess...",
  "world.turn.end.confirm": "You finished yet?",
  ...
  "world.turn.waiting": "Geez, {0} is taking forever to play...",
  "world.turn.waiting.unknown": "Waiting for another retard to play...",
  "world.turn.ready": "Tap save when ready",
  "world.turn.your": "Your turn",
  "world.turn.remaining": "{0} turns left",
  "world.turn.last": "BRUH!",
  ...
  "world.unit.attack": "ULTIMATE POWER",
  "world.unit.defence": "ULTIMATE... defense",
  "world.unit.movement": "Movement",
  "world.unit.range": "Attack Range",
  "world.unit.disembark.title": "Leave {0}",
  "world.unit.disembark.message": "Disembarking this unit will dismantle your {0}. Do you wish to proceed, chief?",
  ...
  "world.building.village": "Empty Civilization",
  "world.building.capture.ready": "I think it Will be ready to capture next turn",
  "world.building.capture.ready.title": "Entering {0}!",
  "world.building.capture.warning": "Hurry and get this shit back or ur fucked.",
  "world.building.capture.warning.title": "{0} is under siege!",
  "world.attract.sanctuary": "Your sanctuary has barfed up an animal",
  ...
  "world.tech.new.message": "You have discovered the secret of {0} :O",
  "world.reward.levelup": "{0} level up!",
  "world.reward.building": "You can now construct {0}! This feeble monument will bring depression and anxiety to the nearest city.",
  ...
  "tribes.xin-xi": "The Samurai",
  "tribes.xin-xi.info": "They start their journey in the dense mountains, surrounded by pretty much nothing. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.imperius": "HOLY ROMAN EMPIRE",
  "tribes.imperius.info": "Huge shit and green piss. The {0} climate is perfect for growing children. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.bardur": "Retards in Black",
  "tribes.bardur.info": "Surviving the harsh eternal winter of the {0} woods is an easy task, and {0} seems to thrive here.\n\n{0} starts the game with the '{1}' tech.",
  "tribes.oumaji": "Sand People",
  "tribes.oumaji.info": "The seemingly endless, sunless desert is the disappointment of the {0} tribe.\n\n{0} starts the game with the '{1}' tech.",
  "tribes.kickoo": "Fish People",
  "tribes.kickoo.info": "White sandy beaches with coconut oil. Abundance of fruit and fish sticks. Welcome to the home of the {0}. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.hoodrick": "Arrow People",
  "tribes.hoodrick.info": "The yellow autumn leaves of the {0} woods are perfect hideouts for its peculiar weed brownie stuffing inhabitants. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.luxidoor": "We're Too Egotistical",
  "tribes.luxidoor.info": "The {0} love expensive things, jewels, rare spices and exclusive condoms. That is also why they are the most expensive tribe in Polytopia!\n\nTheir citizens lead very comfortable lives, draped in the finest purple silk. But will they survive outside the walls of their beloved basement?  \n\n{0} starts the game with a huge walled capital.",
  "tribes.vengir": "Isolation",
  "tribes.vengir.info": "Frowned upon by the other tribes and pushed into the unpleasant wastelands. Will they tolerate this injustice? Yes, yes they will.  \n\n{0} start the game with the '{1}' tech and a powerful Swordman.",
  "tribes.zebasi": "Broke But Efficient",
  "tribes.zebasi.info": "{0} thrive on the warm savannah, cultivating the rich soil to provide nothing for their mighty population. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.zebasi.news": "All profits from the Zebasi tribe is invested in solar energy projects.",
  "tribes.aimo": "Sit and Wait",
  "tribes.aimo.info": "The tranquil and wise {0} tribe inhabits the harshest, windiest and highest mountain range of the square, where they have found inner peace by smashing their heads against stone. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.aquarion": "Fish People V2",
  "tribes.aquarion.info": "From the deep oceans a long lost civilization appears! Their extreme isolation has given them depression that is unknown to the other more human tribes.\n\n{0} have a slightly different tech tree and have access to the unique amphibious turtle units that no other tribe wants.",
  "tribes.quetzali": "BIRDS",
  "tribes.quetzali.info": "The {0} tribe worship the burbs of the red soil and live in harmony with the natural symmetry of their cubistic jungles. They are commonly seen riding the horses in the back. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.elyrion": "Efficient Hippies",
  "tribes.elyrion.info": "The mysterious {0} defend their woodland homes with colorful magic and the ferocity of fire-breathing dragons! \n\nThey regard Nature as a holy spirit and cannot hunt animals or chop down trees, instead they start the game with the unique Enchantment tech that can turn regular animals into worms.",
  "tribes.yadakk": "Yes",
  "tribes.yadakk.info": "Your mom. \n\n{0} starts the game with the '{1}' tech.",
  "tribes.polaris": "Annoying Ice People",
  "tribes.polaris.info": "The {0} have lain trapped in the far reaches of the freezing tundra for a couple weeks, but were blessed by the unknowable Gaami with the power to expand their unnatural icy terrain farther than the weather permits. \n\nWith the might of sleds and Mamoos, the mystical {0} are determined to entomb the Square in ice and transform the land into a frigid paradise. \n\n{0} starts the game with the ability to freeze surrounding terrain using Tax Fraud.",
  ...
  "building.names.monument1": "Bob",
  "building.names.monument2": "Bob",
  "building.names.monument3": "Bob",
  "building.names.monument4": "Bob",
  "building.names.monument5": "Bob",
  "building.names.monument6": "Bob",
  "building.names.monument7": "Bob",
  "building.names.temple": "Useless White Rock",
  "building.names.burnforest": "Burn Wildlife",
  "building.names.road": "Rode"
  "building.names.customshouse": "Star House",
  "building.names.gather": "C O N S U M E",
  "building.names.farm": "Farm",
  "building.names.windmill": "Windmill",
  "building.names.fishing": "Fishing",
  "building.names.whalehunting": "Kill A Whale",
  "building.names.watertemple": "Water Temple",
  "building.names.port": "Port",
  "building.names.hunting": "Hunting",
  "building.names.clearforest": "Chop Trees",
  "building.names.lumberhut": "Treehouse",
  "building.names.sawmill": "Sawmill",
  "building.names.growforest": "Grow Forest",
  "building.names.foresttemple": "Useless White Rock V2",
  "building.names.mountaintemple": "Useless White Rock V3",
  "building.names.mine": "Mine",
  "building.names.forge": "Forge",
  "building.names.sanctuary": "Sanctuary",
  "building.names.enchant": "TURN INTO A FURRY SLAVE",
  "building.names.enchant_whale": "WHALE SOLDIER",
  "building.names.ice_bank": "Ice Bank",
  "building.names.iceport": "Outpost",
  "building.names.icetemple": "Ice Temple",

  "unit": "unit",
  "unit.info.attack": "Fuck 'Em Up",
  "unit.info.defence": "BLOCK, BLOCK!",
  "unit.info.movement": "Movement",
  "unit.info.health": "Health",
  "unit.info.range": "Range",
  "unit.info.skills": "Skills",
  "unit.names.giant": "Big-Ass Dude",
  "unit.names.crab": "C R A B",
  "unit.names.egg": "Dragon Egg",
  "unit.names.wendy": "Lemon-Lime",
  "unit.names.bunny": "Bunny",
  "unit.names.scout": "Scout",
  "unit.names.boat": "Boat",
  "unit.names.warrior": "Basic Man",
  "unit.names.rider": "Fast Basic Man",
  "unit.names.knight": "Slaughterer",
  "unit.names.defender": "Scared Man",
  "unit.names.ship": "Ship",
  "unit.names.battleship": "Battleship",
  "unit.names.catapult": "Catapult",
  "unit.names.archer": "Archer",
  "unit.names.priest": "Jared From Subway",
  "unit.names.swordman": "Swords",
  "unit.names.amphibian": "Amphibian",
  "unit.names.tridention": "Hit & Run",
  "unit.names.dragon": "Sword Dragon",
  "unit.names.dragon_large": "Epic Dragon",
  "unit.names.polytaur": "Bill",
  "unit.names.seamonster": "Whale Soldier",
  ...
  "player.abilities.disband": "eliminate",
  "player.abilities.literacy": "reed booke",
  "player.abilities.glide": "glide",

  "resource.names.fruit": "edible",
  "resource.names.crop": "crop",
  "resource.names.fish": "fish",
  "resource.names.whale": "giant fish",
  "resource.names.game": "free animal",
  ...
  "actionbox.confirm.button": "I THINK SO",
  ...
  "gameinfo.picktribe": "pick your doom",
  "gameinfo.play": "play",
  ...
  "polyplayer.task.explorer.description": "Explore every single tile or face the consequences",
  ...
  "polyplayer.task.pacifist.description": "Meditate for 5 turns",
  "polyplayer.task.killer.title": "Killer",
  "polyplayer.task.killer.description": "Kill 1000 enemies in battle",
  "polyplayer.task.wealth.title": "Wealth",
  "polyplayer.task.wealth.description": "Gather 10000 stars",
  "polyplayer.task.genius.title": "Genius",
  "polyplayer.task.genius.description": "Discover all 26 available technologies",
  "polyplayer.task.metropolis.title": "Metropolis",
  "polyplayer.task.metropolis.description": "Create a level 20 city",
  "polyplayer.task.network.title": "Network",
  "polyplayer.task.network.description": "Connect 40 cities to your capital",
  ...
  "wcontroller.online.yourturn.title": "Go ahead, loser!",
  ...
  "wcontroller.examine.water": "You encountered a band of funky pirates who joined your tribe!",
  "wcontroller.examine.water.title": "Battle ship",
  "wcontroller.examine.giant": "You found a friendly {0} who joined your tribe!",
  "wcontroller.examine.explorer": "You meet some locals who show how useless they really are.",
  ...
  "wcontroller.examine.stars": "The ancient ruins are filled with minimal resources!",
  "wcontroller.examine.stars.title": "Resources",
  "wcontroller.examine.population": "You meet a group of assassins that settle in your capital!",
  ...
  "wcontroller.reward.workshop": "+1 star",
  "wcontroller.reward.citywall": "extra defense",
  "wcontroller.reward.populationgrowth": "population growth",
  "wcontroller.reward.park": "useless points",
  "wcontroller.reward.explorer": "useless man",
  "wcontroller.reward.resources": "stars",
  "wcontroller.reward.bordergrowth": "border growth",
  "wcontroller.reward.superunit": "big guy O_O",
  ...
  "wcontroller.tribe.destroy2": "{0} has been absolutely destroyed by the {1}!",
  "wcontroller.tribe.destroy.all": "You have absolutely destroyed all opposing tribes and unified the entire square under your command!",
  ...
  "wcontroller.turn.end": "Losing willpower...",
  ...
  "technology.names.roads": "Rodes",
  "technology.names.trade": "Fork",
  ...
  "technology.names.philosophy": "Big Smart Time",
  ...
  "techview.expensive.info": "You're broke. Tap 'next turn' to get more stars.",
